...
class GenerateHTML:
    ...
    def buildMainSite(self):
                    ...
                    "<body class = 'body'>"
                        ...
                        "<section class = 'content'>"
                            "<div class='tab three-col'>"
                                "<button class=\"tablinks\" onclick=\"openTab(event, 'Furniture'     )\"id=\"defaultOpen\">Furniture</button>"
                                "<button class=\"tablinks\" onclick=\"openTab(event, 'Maslow'        )\"id=\"maslowBtn\">Maslow</button>"
        ...
        "<div class='three-col'>"
            ...
            "</script>"
            "<script>"
                "if (window.location.search.indexOf('maslow=true') > -1 || window.location.search.indexOf('maslow=True') > -1) {"
                    "document.getElementById('maslowBtn').click();"
                "}"
            "</script>"
        "</div>"  
        "<script>"
                ...
                "<html>"
                    ...
                    "<section class = 'content'>"
                        ...
                        "<div class='tab three-col'>"
                            ...
                            "<button class=\"tablinks\" onclick=\"openTab(event, 'Buy'         )\"id=\"buyBTN\">Buy</button>"
                        "</div>"
                        
                        "<div id='Files' class='tabcontent'>"
                            "<div class='tab-title'>"
                                "<h3 class='two-col'>Files</h3>"
                                "<a href=" + project.editREADMEpath + " class = 'edit_this_page_button' target='_blank'>Edit this page</a>"
                            "</div>"
                            "<table>"
                                "<tr>"
                        ...
                        "<div id='Instructions' class='tabcontent'>"
                            "<div class='tab-title'>"
                                ...
                                "<a href=" + project.editINSTRUCTIONpath + " class = 'edit_this_page_button' target='_blank'>Edit this page</a>"
                            "</div>"
                            "<br>"
                            "<br>"
                            "<br>"
                        ...
                        "<div id='Buy' class='tabcontent'>"
                            "<div class='tab-title'>"
                                ...
                                "<a href=" + project.editBOMpath + " class = 'edit_this_page_button' target='_blank'>Edit this page</a>"
                            "</div>"
                            "<br>"
                            "<br>"
                            "<br>"
                        ...
                        "<div class='three-col'>"
                            ...
                            "</script>"
                            "<script>"
                                "if (window.location.search.indexOf('instructions=true') > -1 || window.location.search.indexOf('instructions=True') > -1) {"
                                    "document.getElementById('instructionsBTN').click();"
                                "}"
                                "if (window.location.search.indexOf('buy=true') > -1 || window.location.search.indexOf('buy=True') > -1) {"
